...
@section('content')
<div class="container">
    <div class="row mt-5 px-3 px-md-0 " style="height: 70vh;">
        {{-- LEFT SIDE --}}
        ...
        <div class="col-md-6 bg-white sm-rounded rounded-end ">
            <h3 class="text-center mt-3"><strong>Login</strong></h3>
            <p class="text-center mt-2 ">Login account to join our forum</p>
            ...
            <form method="POST" class="mt-5 " action="{{ route('login') }}">
                ...
                <div class="row mb-0">
                    <div class="col-md-8 offset-md-4">
                        ...
                        <p class="mt-3 "><strong>don't have an account? <a href="{{ route('register') }}">register</a></strong></p>
                    </div>
                </div>
            </form>
        </div>
